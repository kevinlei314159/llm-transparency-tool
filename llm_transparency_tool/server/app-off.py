...
class App:
    ...
    def run_logit_lens_on_neurons(self, n_layers, sel_neurons_layerwise, subj_voc_id=None, answer_voc_id=None):
        ...
        for layer in range(n_layers):
            ...
            for neuron in sel_neurons:
                ...
                result["rank_subject"] = get_val(torch.argwhere(sorted_indices == subj_voc_id))
                result["rank_answer"] = get_val(torch.argwhere(sorted_indices == answer_voc_id))
    ...
    def run(self):
        ...
        self.sentence = "Paris is the capital of France"
        ...
        with torch.inference_mode():
            ...
            heads_logit_lens_results = self.run_logit_lens_on_heads(model_info.n_heads, model_info.n_heads, subj_voc_id=subj_voc_id, answer_voc_id=answer_voc_id)
            ...
            run_logit_lens_on_neurons = self.run_logit_lens_on_neurons(model_info.n_layers, sel_neurons_layerwise=sel_neurons_layerwise, subj_voc_id=subj_voc_id, answer_voc_id=answer_voc_id)
